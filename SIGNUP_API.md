...
- **Only company emails can sign up:** `@divinevisioninfra.com`. Any other domain gets `422`
  with a `fields` entry for `body.email` ("Only @divinevisioninfra.com email addresses can sign up").
